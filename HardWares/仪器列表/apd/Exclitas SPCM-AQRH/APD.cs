            ...
            try
            {
                ...
                foreach (var item in strs)
                {
                    try
                    {
                        ...
                        DaqContinusReceiveTask.Timing.ConfigureSampleClock(connectchannelName, 1, SampleClockActiveEdge.Rising, SampleQuantityMode.ContinuousSamples, sampleCount == 1 ? 2 : sampleCount);

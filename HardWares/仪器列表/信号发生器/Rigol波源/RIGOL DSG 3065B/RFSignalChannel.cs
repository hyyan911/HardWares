...
namespace HardWares.射频源.Rigol_DSG_3065B
{
    ...
    public partial class RFSignalChannel : SignalChannelBase
    {
        ...
        public override string ChannelName { get; internal set; } = "射频输出通道";
        ...
        public override double Amplitude
        {
            ...
            set
            {
                //if (IsmVUnit)
                //{
                //    AddMessage(":" + SCPIGenerator.GenerateSCPICommannd(false, new bool[] { true }, new string[] { (value / 1000).ToString() + "V" }, "LEV"));
                //}
        ...
        public double AmplitudeLimit
        {
            ...
            set
            {
                //if (IsmVUnit)
                //{
                //    AddMessage(SCPIGenerator.GenerateSCPICommannd(false, new bool[] { true }, new string[] { (value / 1000).ToString() + "V" }, "LEV", "LIM"));
                //}
                //else
                //{
        ...
        ///// 是否使用的dBm作为单位
        ///// </summary>
        //public bool IsmVUnit { get; set; } = true;

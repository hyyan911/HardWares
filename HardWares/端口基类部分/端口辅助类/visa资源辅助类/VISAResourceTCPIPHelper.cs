...
namespace HardWares.端口基类部分.PortHelper
{
    ...
    {
        public VISAResourceTCPIPHelper(Func<string, string> getProductName, char TerminateCharacter)
        {
        ...
        /// <returns></returns>
        public bool ConnectTCPIP(PortObject device, TCPIPDeviceInfo info, out Exception exc, bool reconnect = false)
        {
